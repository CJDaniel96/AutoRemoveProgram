...
class SystemTrayIcon(QSystemTrayIcon):
    def __init__(self, win: QMainWindow, time_settings: QDialog, cycle_settings: QDialog):
        ...
        self.menu = QMenu()
        self.openAction = self.menu.addAction(QIcon(abspath(self.path_string.open_icon)), self.name_string.menu_open)
        self.timeSettingsAction = self.menu.addAction(QIcon(abspath(self.path_string.time_settings_icon)),
                                                      self.name_string.menu_time_settings)
        self.cycleSettingsAction = self.menu.addAction(QIcon(abspath(self.path_string.cycle_settings_icon)),
                                                       self.name_string.menu_cycle_settings)
        self.exitAction = self.menu.addAction(QIcon(abspath(self.path_string.exit_icon)), self.name_string.menu_exit)
        ...
        self.setIcon(QIcon(abspath(self.path_string.system_tray_icon)))
